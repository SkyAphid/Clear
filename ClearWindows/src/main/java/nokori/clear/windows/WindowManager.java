...
import nokori.clear.windows.callback.JoystickStateCallback;
...
public class WindowManager {
    ...
    /**
     * Creates a window centered in the primary monitor.
     */
    public Window createWindow(String title, int width, int height, boolean resizable, boolean decorated) throws GLFWException {
        int centerX = getPrimaryMonitor().getDesktopVideoMode().getWidth() / 2 - width / 2;
        int centerY = getPrimaryMonitor().getDesktopVideoMode().getHeight() / 2 - height / 2;
        return createWindow(title, centerX, centerY, width, height, resizable, decorated);
    }

    /**
     * Creates a window with minimal customization.
     */
    public Window createWindow(String title, int x, int y, int width, int height, boolean resizable, boolean decorated) throws GLFWException {
        return createWindow(title, x, y, width, height, resizable, decorated, false);
    }

    /**
     * Creates a window with minimal customization.
     */
    public Window createWindow(String title, int x, int y, int width, int height, boolean resizable, boolean decorated, boolean debugContext) throws GLFWException {
        ...
        return createWindow(title, x, y, width, height, pixelFormat, contextParams, resizable, decorated);
    }

    /**
     * Creates a fully customizable window.
     */
    public Window createWindow(String title, int x, int y, int width, int height, PixelFormat pixelFormat, ContextParams contextParams, boolean resizable, boolean decorated) throws GLFWException {
